...
2. Import the project into your IDE:
   ...
   **IntelliJ:**
   ...
   2. Navigate to the folder where you checked out the project (**bulletinboard-ads-cap**) and click `OK`

   **VS Code:**
   1. Open VS Code
   2. Choose `File > Open Folder...`
   3. Navigate to the **bulletinboard-ads-cap** folder and click `Select Folder`
...
At the end of each exercise we instruct you to do some smoke testing. We recommend you use Bruno to perform these smoke tests.
...
You have learned:
- [x] How to check out a project from git
- [x] How to initialize a CAP Java project and import it in your IDE
- [x] How to start a CAP Java project using the command line
